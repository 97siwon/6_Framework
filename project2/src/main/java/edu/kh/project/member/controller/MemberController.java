...
public class MemberController {
	...
	// 자동 연결 규칙 : 타입이 같거나 상속 괸계인 bean을 자동으로 API
...
//	@RequestMapping(value="/member/login", method = RequestMethod.POST)
	...
	// -> Spring Controller에서 Argument Resolver(매개변수 해결사) 제공해서
	//    유연하게 처리함
	...
	public String login(/* @ModelAttribute */ Member inputMember,
		...
		if(loginMember != null) {
			...
			// addAttributes("K", V) == req.setAttribute("K",V)
	...
	public String signUp(/* @ModelAttribute */ Member inputMember /* 커멘드 객체 */,
			             String[] memberAddress /* name 속성값이 memberAddress인 값을 배열로 반환 */,
			             RedirectAttributes ra,
			             @RequestHeader("referer") String referer) {
		
		// 한글이 깨지는 이유
		// -> POST 요청 시 인코딩 처리 필요 -> 인코딩 필터로 처리(web.xml 참고)
	...
	public String exceptionhandler(Exception e, Model model) {
		...
		// 매개변수 Excception e : 발생한 예외 전달 받는 매개변수
