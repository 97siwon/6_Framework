...
public class myPageController {
	...
	public String updateInfo(Member inputMember, String[] memberAddress,
		...
		// memberAddress : 입력된 우편번호, 주소, 상세 주소가 담긴 배열
	...
	public String memberDelete(
		...
		// ex) session에서 "loginMember"를 없애야함
	...
	public String updateProfile(
			...
			@SessionAttribute("loginMember") Member loginMember, /* 로그인 회원 정보 필요 */
		...
		return "redirect:profile";
		       // == "redirect:/member/myPage/profile";
	}
